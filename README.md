...
Unlike traditional jukebox musicals—which are usually tied to just one artist or album (Mamma Mia! = ABBA, Jersey Boys = The Four Seasons)—this generator (or at least was supposed to) pull from different artists and different albums to create something fresh. 

That’s why I called it JukeCrate. A crate holds a bunch of different stuff, and that’s what I wanted this project to do: bring together multiple influences to create something new. But the code behind playlist generation is still really wonky so I'm still working on making that better.
